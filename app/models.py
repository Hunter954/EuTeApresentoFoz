...
class Post(db.Model):
    ...
    wp_id = db.Column(db.Integer, unique=True, index=True, nullable=True)
    source = db.Column(db.String(20), default="wp")  # wp | local | hub
...
class Product(db.Model):
    ...
    slug = db.Column(db.String(220), nullable=False, unique=True, index=True)
    description = db.Column(db.Text, nullable=True)
    price_label = db.Column(db.String(60), nullable=True)
    image_url = db.Column(db.String(800), nullable=True)
    buy_url = db.Column(db.String(1000), nullable=True)
    sort_order = db.Column(db.Integer, default=0, nullable=False)
    is_active = db.Column(db.Boolean, default=True, nullable=False)
    created_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow, nullable=False)
...
class BeforeAfter(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    title = db.Column(db.String(220), nullable=False)
    before_image = db.Column(db.String(800), nullable=True)
    after_image = db.Column(db.String(800), nullable=True)
    location = db.Column(db.String(220), nullable=True)
    year_before = db.Column(db.String(40), nullable=True)
    year_after = db.Column(db.String(40), nullable=True)
    sort_order = db.Column(db.Integer, default=0, nullable=False)
    is_active = db.Column(db.Boolean, default=True, nullable=False)
    created_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow, nullable=False)
...
class WhatsAppGroup(db.Model):
    ...
    name = db.Column(db.String(220), nullable=False)
    description = db.Column(db.Text, nullable=True)
    icon_class = db.Column(db.String(80), nullable=True, default='bi-people-fill')
    member_count = db.Column(db.String(60), nullable=True)
